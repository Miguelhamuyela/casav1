                        ...
                        @foreach ($fairs as $item)
                                <div class="col-lg-6 col-md-12 col-12">
                                    ...
                                    <div class="single-event mb-50 mt-2">
                                        <div class="event-img">
                                            <a href="{!! url('/feiras/' . urlencode($item->title)) !!}">
                                                <img class="img-fluid" src="/storage/{{ $item->image }}" alt="event">
                                            </a>
                                        </div>
                                        <div class="event-content text-start">

                                            <h4><a href="{!! url('/feiras/' . urlencode($item->title)) !!}">{!! html_entity_decode(mb_substr($item->title, 0, 30, 'UTF-8')) !!}</a></h4>
                                            ...
                                            <div class="event-content-right">
                                                <a class="default-btn" href="{!! url('/feiras/' . urlencode($item->title)) !!}">Saber Mais</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
