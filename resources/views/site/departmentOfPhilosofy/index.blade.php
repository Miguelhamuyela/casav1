...
@section('titulo', 'Departamento de Filosofia')
@section('content')
...
<main id="main">
    ...
    <div class="breadcrumbs aos-init aos-animate" data-aos="fade-in">
      <div class="container">
        <h2 class="mt-5">Departamento de Filosofia</h2>
       </div>
    </div><!-- End Breadcrumbs -->
                ...
                <div class="container aos-init aos-animate" data-aos="fade-up">
                  ...
                  <div class="row">
                    <div class="col-lg-5 aos-init aos-animate" data-aos="fade-left" data-aos-delay="100">
                      <img src="/storage/{{$departmentOfPhilosofy->image}}" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-7 ">
                      <p class="fst-italic">
                        <h3>{{$departmentOfPhilosofy->title}}</h3>
