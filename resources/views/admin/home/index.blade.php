...
@section('titulo', 'Portal Oficial Faculdade de Humanidades da Universidade Agostinho Neto')
@section('content')
    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title">
                Portal da Faculdade de Humanidades da Universidade Agostinho Neto<br>
            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col pr-0">
                            <p class="small text-dark mb-0">Oferta Formativa</p>
