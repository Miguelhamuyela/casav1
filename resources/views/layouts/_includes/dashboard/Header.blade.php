...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/site/assets/img/favicon-uan.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/site/assets/img/favicon-uan.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/site/assets/img/favicon-uan.png">
