        ...
        <div class="card-deck mb-4">
            ...
            <div class="card border-0 bg-transparent">
                <div class="card-img-top img-fluid rounded"
                    style='background-image:url("/storage/{{ $HumanResourcesDepartment->image }}");background-position:center;background-size:cover;height:800px;'>
                </div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($HumanResourcesDepartment->title) ? $HumanResourcesDepartment->title : '' }}"
...
<div class="col-md-12 mb-4">
    <div class="card shadow">
        <div class="card-body">
           ...
           {{ isset($HumanResourcesDepartment->body) ? $HumanResourcesDepartment->body : '' }}
            </textarea>
        </div>
    </div>
</div>
