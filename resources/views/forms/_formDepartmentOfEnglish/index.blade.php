        ...
        <div class="card-deck mb-4">
            ...
            <div class="card border-0 bg-transparent">
                <div class="card-img-top img-fluid rounded"
                    style='background-image:url("/storage/{{ $departmentOfEnglish->image }}");background-position:center;background-size:cover;height:800px;'>
                </div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($departmentOfEnglish->title) ? $departmentOfEnglish->title : old('title') }}"
...
<div class="col-md-12 mb-4">
        ...
        <div class="card-departmentOfEnglish">
            ...
            <textarea name="body" id="editor1" style="min-height:300px; min-width:100%">
                {{ isset($departmentOfEnglish->body) ? $departmentOfEnglish->body : old('body') }}
            </textarea>
        </div>
