        ...
        <div class="card-deck mb-4">
            ...
            <div class="card border-0 bg-transparent">
                <div class="card-img-top img-fluid rounded"
                    style='background-image:url("/storage/{{ $festivals->image}}");background-position:center;background-size:cover;height:700px;'>
                </div>
...
<div class="col-md-8">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($festivals->title) ? $festivals->title : old('title') }}"
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="date" name="dateEvent" id="date" value="{{ isset($festivals->dateEvent) ? $festivals->dateEvent : old('date') }}"
    ...
    <div class="form-group">
        <div class="custom-file">
            ...
            <input type="text" class="form-control border-secondary" name="localization" placeholder="Localização"
                value="{{ isset($festivals->localization) ? $festivals->localization : old('localization') }}"
                id="localization">
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <input type="time" name="startTime" id="startTime"
            value="{{ isset($festivals->startTime) ? $festivals->startTime : old('startTime') }}"
            class="form-control border-secondary" required>
    </div>
</div> <!-- /.col -->
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <input type="time" name="endTime" id="endTime"
            value="{{ isset($festivals->endTime) ? $festivals->endTime : old('endTime') }}"
...
<div class="col-md-12 mb-4">
    <div class="card shadow">
        <div class="card-body">
           ...
           {{ isset($festivals->body) ? $festivals->body : '' }}
            </textarea>
        </div>
    </div>
</div>
