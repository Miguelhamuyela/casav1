        ...
        <div class="card-deck mb-4">
            ...
            <div class="card border-0 bg-transparent">
                <div class="card-img-top img-fluid rounded"
                    style='background-image:url("/storage/{{ $scientificArticle->cover }}");background-position:center;background-size:cover;height:200px;'>
                </div>
...
<div class="col-md-8">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($scientificArticle->title) ? $scientificArticle->title : old('title') }}"
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="date" name="eventDate" id="date" value="{{ isset($scientificArticle->eventDate) ? $scientificArticle->eventDate : old('date') }}"
