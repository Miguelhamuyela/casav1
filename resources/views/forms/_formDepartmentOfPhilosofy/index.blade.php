        ...
        <div class="card-deck mb-4">
            ...
            <div class="card border-0 bg-transparent">
                <div class="card-img-top img-fluid rounded"
                    style='background-image:url("/storage/{{ $departmentOfPhilosofy->image }}");background-position:center;background-size:cover;height:800px;'>
                </div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($departmentOfPhilosofy->title) ? $departmentOfPhilosofy->title : old('title') }}"
...
<div class="col-md-12 mb-4">
        ...
        <div class="card-departmentOfPhilosofy">
            ...
            <textarea name="body" id="editor1" style="min-height:300px; min-width:100%">
                {{ isset($departmentOfPhilosofy->body) ? $departmentOfPhilosofy->body : old('body') }}
            </textarea>
        </div>
