        ...
        <div class="card-deck mb-4">
            ...
            <div class="card border-0 bg-transparent">
                <div class="card-img-top img-fluid rounded"
                    style='background-image:url("/storage/{{ $scienceAndTechnology->path }}");background-position:center;background-size:cover;height:200px;'>
                </div>
...
<div class="col-md-8">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($scienceAndTechnology->title) ? $scienceAndTechnology->title : old('title') }}"
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="date" name="date" id="date" value="{{ isset($scienceAndTechnology->date) ? $scienceAndTechnology->date : old('date') }}"
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <textarea name="body" id="editor1" style="min-height:300px; min-width:100%" >
                {{ isset($scienceAndTechnology->body) ? $scienceAndTechnology->body : old('body')}}
            </textarea>
        </div>
    </div>
</div>
